...
Ext.define('Ext.ux.myPaging', {
    ...
    updateInfo : function(){
        ...
        msg=Ext.String.format(me.afterPageText,pageData.currentPage,pageData.pageCount);
        me.child('#afterTextItem').setText(msg);
    },
    ...
    getGoInputItem: function(){
        return this.child('#gotoinput');
    },
    ...
    readPageFromInput : function(pageData){
        ...
        // }
        // return pageNum;
        var inputItem = this.getGoInputItem(),
            pageNum = false,
            v;
